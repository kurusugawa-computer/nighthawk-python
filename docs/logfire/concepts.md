...
## What is a Span?[¶](concepts/#what-is-a-span)
...
[![Spans](images/concepts/spans.png)](images/concepts/spans.png)

## What is a Trace?[¶](concepts/#what-is-a-trace)
...
[![Trace](images/concepts/trace.png)](images/concepts/trace.png)

### Example - File size counter[¶](concepts/#example-file-size-counter)
...
[![Counting size of loaded files screenshot](images/logfire-screenshot-first-steps-load-files.png)](images/logfire-screenshot-first-steps-load-files.png)

---

### Example - Happy Birthday[¶](concepts/#example-happy-birthday)
...
[![Logfire hello world screenshot](images/index/logfire-screenshot-hello-world-age.png)](images/index/logfire-screenshot-hello-world-age.png)
...
## What is a Metric?[¶](concepts/#what-is-a-metric)
...
### Example - Duration of HTTP requests[¶](concepts/#example-duration-of-http-requests)
...
see the [adding metrics guide](guides/onboarding-checklist/add-metrics/).

## What is a Log?[¶](concepts/#what-is-a-log)
