...
!!! note "Note"
    This is separate from the [`anthropic` integration](../../integrations/llms/anthropic/). The Claude Agent SDK doesn't actually use the `anthropic` package under the hood.
...
[![Logfire Claude Agent SDK Trace](../../images/logfire-screenshot-claude-agent-sdk.png)](../../images/logfire-screenshot-claude-agent-sdk.png)
